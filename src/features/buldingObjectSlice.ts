...
export const getBuldingObject = createAsyncThunk<BuldingObject[],void, {rejectValue: string | unknown}>(
  "bulding/getbuldingonject",
  async (_, thunkAPI) => {
    try {
...
export const buldingObjectSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getBuldingObject.fulfilled, (state , action:PayloadAction<BuldingObject[]>)=>{
    ...
    .addCase(getBuldingObject.rejected, (state, action:PayloadAction<string | unknown | null>)=>{
