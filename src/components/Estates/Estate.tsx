...
function Estate() {
  ...
  const handleComparison = (estateId) => {
    dispatch(addComparison(estateId))
  }
            ...
            return (
             ...
             <div className={styles.card_top}>
                  ...
                  <div className={styles.vertical_svg}>
                   ...
                   {
                    comparison?.includes(item._id)
                    ?
                     <svg className={styles.comparison} onClick={() => handleComparison(item._id)}  width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <rect x="18.6484" y="0.25" width="4.1" height="23.42" fill="#B68D5C" stroke="#B68D5C" strokeWidth="0.5"/>
                     <rect x="9.44922" y="7.61035" width="4.1" height="16.06" fill="#B68D5C" stroke="#B68D5C" strokeWidth="0.5"/>
                     <rect x="0.25" y="13.1299" width="4.1" height="10.54" fill="#B68D5C" stroke="#B68D5C" strokeWidth="0.5"/>
                     </svg>
                  : <svg  className={styles.comparison} onClick={() => handleComparison(item._id)} width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
